...
Before you begin using TeXbld, you must install it and its only dependency.
...
4. Run `pip install texbld` from your command line, which pulls the latest version of TeXbld from the pypi registry.
...
2. `~/.cache/texbld` - cache directory
