      ...
      <Container>
        ...
        <Box m={2}>
          ...
          <Text>
            ...
            template, was written. This first implementation, however, relied on
            a Makefile whose commands were run directly on the system, leaving
            the build process vulnerable to arbitrary system changes.
          </Text>
          <Text>
            Docker extensions were then added to mktex so that one could compile
            a paper in an isolated container with its own pre-determined
            dependencies. Although somewhat successful at yielding reproducible
            papers, the docker image (junikimm717/mktex-build) was a single
            point of failure. This image was also extremeley bloated since it
            had to be capable of building every type of paper, instead of being
            specialized.
          </Text>
          <Text>
